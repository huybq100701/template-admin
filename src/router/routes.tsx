...
const Live = lazy(() => import('../pages/Ticket/Live'));
const Agency = lazy(() => import('../pages/Ticket/Agency'));
const PreOrder = lazy(() => import('../pages/Ticket/PreOrder'));
const Transaction = lazy(() => import('../pages/Ticket/Transaction'));
const Order = lazy(() => import('../pages/Ticket/Order'));

const ChangeRfid = lazy(() => import('../pages/Report/ChangeRfid'));
const Checkinout = lazy(() => import('../pages/Report/Checkinout'));
const Product = lazy(() => import('../pages/Report/Product'));
const Revenue = lazy(() => import('../pages/Report/Revenue'));
const Sale = lazy(() => import('../pages/Report/Sale'));
const Ticket = lazy(() => import('../pages/Report/Ticket'));
const Topup = lazy(() => import('../pages/Report/Topup'));

const Device = lazy(() => import('../pages/Category/Device'));
const Event = lazy(() => import('../pages/Category/Event'));
const Rfid = lazy(() => import('../pages/Category/Rfid'));
const TicketType = lazy(() => import('../pages/Category/TicketType'));

const Campaign = lazy(() => import('../pages/Admin/Campaign'));
const Coupon = lazy(() => import('../pages/Admin/Coupon'));
const CouponGroup = lazy(() => import('../pages/Admin/CouponGroup'));
const Customer = lazy(() => import('../pages/Admin/Customer'));
const User = lazy(() => import('../pages/Admin/User'));
const UserGroup = lazy(() => import('../pages/Admin/UserGroup'));
...
const routes = [
    ...
    {
        path: '/report/change-rfid',
        element: <ChangeRfid />,
    },
    {
        path: '/report/checkin-checkout',
        element: <Checkinout />,
    },
